...
const (
	...
	EntryConfChangeAddLearner EntryType = 2
)

var EntryType_name = map[int32]string{
	0: "EntryNormal",
	1: "EntryConfChange",
	2: "EntryConfChangeAddLearner",
}

var EntryType_value = map[string]int32{
	"EntryNormal":               0,
	"EntryConfChange":           1,
	"EntryConfChangeAddLearner": 2,
}
...
const (
	...
	ConfChangeAddLearner ConfChangeType = 2
)

var ConfChangeType_name = map[int32]string{
	0: "ConfChangeAddNode",
	1: "ConfChangeRemoveNode",
	2: "ConfChangeAddLearner",
}

var ConfChangeType_value = map[string]int32{
	"ConfChangeAddNode":    0,
	"ConfChangeRemoveNode": 1,
	"ConfChangeAddLearner": 2,
}
...
var fileDescriptor_b042552c306ae59b = []byte{
	...
	,
}
...
func (m *Message) Unmarshal(dAtA []byte) error {
	...
	if hasFields[0]&uint64(0x00000100) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("denied")
	}
